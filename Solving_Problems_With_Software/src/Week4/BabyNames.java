...
public class BabyNames {
    ...
    {
        int rank=1;
        for(CSVRecord rec:new FileResource("Week4/testing/"+"yob"+year+"short.csv").getCSVParser(false))
        {
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("Mason Rank in 2012 file  "+obj.getRank(2012,"Mason","M"));
        int year=2012,newyear=2014;
        String name="Isabella",gender="F";

        obj.whatIsNameInYear(name,year,newyear,gender);
        System.out.println("Year of highest rank for Mason-M");
        System.out.println(obj.yearOfHighestRank("Mason","M"));
        System.out.println("AverageRank of Jacob-M");
        System.out.println(obj.getAverageRank("Jacob","M"));
        System.out.println("Total births ranked higher in 2012");
